...
const metricsByStop = new Map<string, ApiMetrics>([
  [
    'de:01056:9001',
    {
      ...
      averageSeconds: 45 * 60,
      medianSeconds: 45 * 60,
      p90Seconds: 50 * 60,
      p90Publishable: true,
      medianPublishable: true,
      totalSampleCount: 240,
      reachableSampleCount: 240,
      ...
      averageWalkSeconds: 4 * 60,
      averageInVehicleSeconds: 34 * 60,
      firstConnectionAt: '2026-07-07T05:10:00+02:00',
      lastConnectionAt: '2026-07-08T00:30:00+02:00',
      maxServiceGapSeconds: 30 * 60,
  ...
  [
    'de:02000:8002550',
    {
      ...
      averageWalkSeconds: 4 * 60,
      averageInVehicleSeconds: 22 * 60,
      firstConnectionAt: '2026-07-07T05:08:00+02:00',
      lastConnectionAt: '2026-07-08T00:44:00+02:00',
      maxServiceGapSeconds: 20 * 60,
      quantileMethod: 'nearest-rank-p90',
    },
  ],
  [
    'de:01056:9100',
    {
      ...
      averageSeconds: 72 * 60,
      medianSeconds: 70 * 60,
      p90Seconds: 88 * 60,
      p90Publishable: true,
      medianPublishable: true,
      totalSampleCount: 240,
      reachableSampleCount: 228,
      ...
      averageWalkSeconds: 6 * 60,
      averageInVehicleSeconds: 47 * 60,
      firstConnectionAt: '2026-07-07T05:24:00+02:00',
      lastConnectionAt: '2026-07-08T00:12:00+02:00',
      maxServiceGapSeconds: 45 * 60,
      quantileMethod: 'nearest-rank-p90',
    },
  ],
])
